...
Object.freeze(new ia);Object.freeze(new ia);Object.freeze({});function M(){this.s=this.s;this.B=this.B}
...
function Q(a){a=a===void 0?{}:a;M.call(this);this.i=[];this.h={};this.D=this.g=0;this.C=this.l=!1;this.u=[];this.A=this.F=!1;for(var b=n(oa),c=b.next();!c.done;c=b.next())this.i[c.value]=[];this.j=0;this.N=a.timeout||1;this.o=na;this.m=0;this.H=this.R.bind(this);this.M=this.T.bind(this);this.J=this.O.bind(this);this.K=this.P.bind(this);this.L=this.S.bind(this);if(b=!!window.requestIdleCallback&&!!window.cancelIdleCallback)b=P("EXPERIMENT_FLAGS",{}).disable_scheduler_requestIdleCallback,b=!(typeof b===
...
Q.prototype=ca(M.prototype);Q.prototype.constructor=Q;if(t)t(Q,M);else for(var R in M)if(R!="prototype")if(Object.defineProperties){var ra=Object.getOwnPropertyDescriptor(M,R);ra&&Object.defineProperty(Q,R,ra)}else Q[R]=M[R];function sa(a,b){var c=Date.now();S(b);b=Date.now()-c;a.l||(a.o-=b)}
